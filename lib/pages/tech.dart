...
class Tech extends StatefulWidget {
  ...
  @override
  State<Tech> createState() => _HorrorState();
}

class _HorrorState extends State<Tech> {
  late List<bookmodel> tech = [];
    ...
    return  Scaffold(
       appBar: AppBar(
        ...
        title: Padding(
          ...
          child: Text('tech books',style: TextStyle(fontWeight: FontWeight.bold,color: color.white),),
        ),
      ),
      body: Padding(
        ...
        child: ListView.separated(
          itemBuilder: (ctx, index) {
            final bookmodel value = tech[index];
