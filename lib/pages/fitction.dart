...
class Fitction extends StatefulWidget {
  const Fitction({Key? key}) : super(key: key);

  @override
  State<Fitction> createState() => _HorrorState();
}

class _HorrorState extends State<Fitction> {
  late List<bookmodel> fitction = [];
    ...
    return  Scaffold(
       appBar: AppBar(
        ...
        title: const Padding(
          ...
          child: Text('fiction books',style: TextStyle(fontWeight: FontWeight.bold,color: color.white),),
        ),
      ),
      body: Padding(
        ...
        child: ListView.separated(
          itemBuilder: (ctx, index) {
            final bookmodel value = fitction[index];
